## 用此修改后的源码文件覆盖位于captcha\image.py的源码文件
# 定位方法：从./auth/genCaptcha.py 点击 "from captcha.image import ImageCaptcha" 中的ImageCaptcha类跳转进入
# 作用：修改验证码倾斜角度 [-10 degree, +10 degree]（此文件 178行）
#      扩大字符相隔间隙（此文件 220行）
...
class ImageCaptcha(_Captcha):
    ...
    def create_captcha_image(self, chars, color, background):
        ...
        for im in images:
            ...
            offset = offset + w + random.randint(-int(rand / 2), 0)
